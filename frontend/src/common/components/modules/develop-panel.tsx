...
const DevelopPanel = () => {
  const baseColors = [
    ...
    },
    {
      ...
      colors: [
        { name: 'color-espresso-50', className: 'bg-[var(--color-espresso-50)]' },
        { name: 'color-espresso-100', className: 'bg-[var(--color-espresso-100)]' },
        { name: 'color-espresso-200', className: 'bg-[var(--color-espresso-200)]' },
        { name: 'color-espresso-300', className: 'bg-[var(--color-espresso-300)]' },
        { name: 'color-espresso-400', className: 'bg-[var(--color-espresso-400)]' },
        { name: 'color-espresso-500', className: 'bg-[var(--color-espresso-500)]' },
        { name: 'color-espresso-600', className: 'bg-[var(--color-espresso-600)]' },
        { name: 'color-espresso-700', className: 'bg-[var(--color-espresso-700)]' },
        { name: 'color-espresso-800', className: 'bg-[var(--color-espresso-800)]' },
        { name: 'color-espresso-900', className: 'bg-[var(--color-espresso-900)]' },
      ],
    },
  ]
